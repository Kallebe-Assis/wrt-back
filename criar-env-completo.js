...
console.log('🔧 CRIANDO ARQUIVO .env COMPLETO...');

const envContent = `# Configurações do Servidor
PORT=5000
NODE_ENV=development

# Configurações do Firebase (projeto wrtmind)
...
try {
  ...
  if (fs.existsSync('.env')) {
    fs.unlinkSync('.env');
    console.log('🗑️  Arquivo .env anterior removido');
  }
